...
export const FACETS: (SearchFacetDivider | SearchFacetGroup | SearchFacetInputProps)[] = [
  ...
  divider,
  inputs.title,
  inputs.altText_de_DE,
  inputs.altText_de_LI,
  inputs.altText_en_DE,
  inputs.altText_en_LI,
  inputs.description_de_DE,
  inputs.description_de_LI,
  inputs.description_en_DE,
  inputs.description_en_LI,
  divider,
  inputs.isOpaque,
  divider,
  inputs.fileName,
