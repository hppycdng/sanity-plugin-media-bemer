...
type CustomFields = {
  altText_de_DE?: string
  altText_de_LI?: string
  altText_en_DE?: string
  altText_en_LI?: string
  description_de_DE?: string
  description_de_LI?: string
  description_en_DE?: string
  description_en_LI?: string
  opt?: {
    media?: {
